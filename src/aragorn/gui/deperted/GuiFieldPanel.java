...
public abstract class GuiFieldPanel extends GuiPanel {
	...
	protected GuiFieldPanel(GuiFrame parent, String prefix, String suffix, String button_text) {
		...
		button.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				try {
					...
					parent.echo(String.format("The input must be %s.", getValueTypeNameWithIndefiniteArticle()), GuiFrame.ERROR_MESSAGE);
				} finally {
		...
		this.default_size = getPreferredSize();
	}
	...
	public static abstract class Double extends GuiFieldPanel.RangedDouble {
		...
		public Double(GuiFrame parent, String prefix, String suffix, String button_text, double default_value) {
			super(parent, prefix, suffix, button_text, default_value, java.lang.Double.NEGATIVE_INFINITY, java.lang.Double.POSITIVE_INFINITY);
		}
	...
	public static abstract class Integer extends GuiFieldPanel.RangedInteger {
		...
		public Integer(GuiFrame parent, String prefix, String suffix, String button_text, int default_value) {
			super(parent, prefix, suffix, button_text, default_value, java.lang.Integer.MIN_VALUE, java.lang.Integer.MAX_VALUE);
		}
	...
	public static abstract class RangedDouble extends GuiFieldPanel {
		...
		public RangedDouble(GuiFrame parent, String prefix, String suffix, String button_text, double default_value, double lower_bound, double upper_bound) {
			super(parent, prefix, suffix, button_text);
	...
	public static abstract class RangedInteger extends GuiFieldPanel {
		...
		public RangedInteger(GuiFrame parent, String prefix, String suffix, String button_text, int default_value, int lower_bound, int upper_bound) {
			super(parent, prefix, suffix, button_text);
			if (lower_bound > default_value || upper_bound < default_value) {
				throw new InvalidParameterException("The error happened for the bounds.");
			}
